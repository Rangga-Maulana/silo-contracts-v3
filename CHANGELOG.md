...
## [4.18.0] - 2026-05-13
### Added
- `SiloDeployer` deployment

### Changed
- additional options for silo deployer (#1904)

### Fixed
- init HookV1 correctly

## [4.17.0] - 2026-05-11
### Added
- `PermissionedLiquidationController` re-deployment 
...
- deploy `VirtualTokenPrice` contract
...
## [4.2.0] - 2026-02-23
### Added
- silo-oracles: manageable oracle
...
## [3.18.0] - 2026-02-11
### Markets
- sUSDp / USDC new market on Avalanche
- ezETH / WETH new market on Arbitrum
...
- silo-core: `PT-USDai-19FEB2026 / USDC` new market on Arbitrum
- silo-core: `PT-thBILL-19FEB2026 / USDC` new market on Arbitrum
